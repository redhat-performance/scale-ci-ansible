...
## RHCOS Metering Install

The RHCOS metering install playbook is `OCP-4.X/metering-install.yml`
...
$ # Edit vars in OCP-4.X/vars/metering-install.yml or define Environment vars (See below)
$ time ansible-playbook -vv -i inventory OCP-4.X/metering-install.yml
```

### Environment variables for RHCOS metering install playbook
...
ORCHESTRATION_USER
###############################################################################
# RHCOS metering install variables.
###############################################################################

METERING_NODESELECTOR_INFRA

METERING_REPORTING_OPERATOR_REQUESTS_MEM
METERING_REPORTING_OPERATOR_REQUESTS_CPU
METERING_REPORTING_OPERATOR_LIMITS_MEM
METERING_REPORTING_OPERATOR_LIMITS_CPU

METERING_PRESTO_COORDINATOR_REQUESTS_MEM
METERING_PRESTO_COORDINATOR_REQUESTS_CPU
METERING_PRESTO_COORDINATOR_LIMITS_MEM
METERING_PRESTO_COORDINATOR_LIMITS_CPU

METERING_PRESTO_WORKER_REPLICAS
METERING_PRESTO_WORKER_REQUESTS_MEM
METERING_PRESTO_WORKER_REQUESTS_CPU
METERING_PRESTO_WORKER_LIMITS_MEM
METERING_PRESTO_WORKER_LIMITS_CPU

METERING_HIVE_METASTORE_REQUESTS_MEM
METERING_HIVE_METASTORE_REQUESTS_CPU
METERING_HIVE_METASTORE_REQUESTS_CPU
METERING_HIVE_METASTORE_LIMITS_CPU
METERING_HIVE_META_SSIZE

METERING_HIVE_SERVER_REQUESTS_MEM
METERING_HIVE_SERVER_REQUESTS_CPU
METERING_HIVE_SERVER_LIMITS_MEM
METERING_HIVE_SERVER_LIMITS_CPU

METERING_HDFS_DATA_REPLICAS
METERING_HDFS_DATANODE_REQUESTS_MEM
METERING_HDFS_DATANODE_REQUESTS_CPU
METERING_HDFS_DATANODE_LIMITS_MEM
METERING_HDFS_DATANODE_LIMITS_CPU
METERING_HDFS_DATA_SSIZE

METERING_HDFS_NAMENODE_REQUESTS_MEM
METERING_HDFS_NAMENODE_REQUESTS_CPU
METERING_HDFS_NAMENODE_LIMITS_MEM
METERING_HDFS_NAMENODE_LIMITS_CPU
METERING_HDFS_NAME_SSIZE
```
